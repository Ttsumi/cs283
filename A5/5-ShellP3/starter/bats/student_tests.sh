...
EOF
    ...
    expected_output="batsdragon.cdragon.txtdshdsh_cli.cdshlib.cdshlib.hmakefiledsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="${initial_dir}dsh3> dsh3> dsh3> cmd loop returned 0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="${initial_dir}/batsdsh3> dsh3> dsh3> cmd loop returned 0"
